...
<div class="nav">
  <ul>
    <li class="active"> <a href="index.php">&nbsp&nbsp&nbsp Home &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp|</a> </li>
	<li> <a href="regform.php">&nbsp&nbsp&nbsp Registration &nbsp&nbsp&nbsp&nbsp&nbsp|</a> </li>
	<li> <a href="#">&nbsp&nbsp Payment Guidelines & Policies &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp|</a> </li>
	<li> <a href="#">&nbsp&nbsp&nbsp Other Tenders &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp|</a> </li>
	<li> <a href="#">&nbsp&nbsp&nbsp FAQ's &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a> </li>
  </ul>
</div>
...
Obtain the Class 3 Digital Signature from any Certifying Authority.<br>
...
<td>RTGS CODE:<td><input type=text name="t9"/><br/><br/><tr>
